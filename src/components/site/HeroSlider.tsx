...
const slides: Slide[] = [
  {
    ...
    body: "Caring for orphans, widows, and the elderly across Nigeria — supporting the whole family, not just the child.",
  },
  {
    image: "/stories/mbora-community-visit-empowering-women-2019.jpg",
    eyebrow: "Empowering women in need",
    title: "Restoring dignity,",
    highlight: "one family at a time",
    body: "From the Mbora community to homes across the FCT, we put relief and empowerment directly into the hands that need it.",
  },
  {
    image: "/stories/prelli-fun-fair-for-orphans-and-widows-2019.jpg",
    eyebrow: "Joy for orphans & widows",
    title: "Every act of kindness",
    highlight: "brings hope & relief",
    body: "Fun fairs, food drives, and outreach — creating moments of joy and lasting change for vulnerable communities.",
  },
  {
